...
// $Id: stepper.cpp,v 1.23 2016/08/09 00:39:10 mikem Exp $
...
stepper::stepper(uint8_t interface, uint8_t pin1, uint8_t pin2, uint8_t pin3, uint8_t pin4, bool enable)
{
...
stepper::stepper(void (*forward)(), void (*backward)())
{
    _interface = 0;
    _currentPos = 0;
    _targetPos = 0;
...
void stepper::setMinPulseWidth(unsigned int minWidth)
{
...
void stepper::setPinsInverted(bool directionInvert, bool stepInvert, bool enableInvert)
{
...
void stepper::setPinsInverted(bool pin1Invert, bool pin2Invert, bool pin3Invert, bool pin4Invert, bool enableInvert)
{
