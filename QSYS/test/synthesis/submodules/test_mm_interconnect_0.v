...
module test_mm_interconnect_0 (
	...
	wire    [4:0] rsp_mux_src_channel;                                                                                 // rsp_mux:src_channel -> video_pixel_buffer_dma_0_avalon_pixel_dma_master_agent:rp_channel
	...
	wire    [4:0] cmd_mux_001_src_channel;                                                                             // cmd_mux_001:src_channel -> video_pixel_buffer_dma_0_avalon_control_slave_agent:cp_channel
	...
	wire   [89:0] pixel_buffer_avalon_sram_slave_agent_rp_data;                                                        // pixel_buffer_avalon_sram_slave_agent:rp_data -> router_003:sink_data
	...
	wire   [89:0] router_003_src_data;                                                                                 // router_003:src_data -> pixel_buffer_avalon_sram_slave_rsp_width_adapter:in_data
	wire          router_003_src_ready;                                                                                // pixel_buffer_avalon_sram_slave_rsp_width_adapter:in_ready -> router_003:src_ready
	wire    [4:0] router_003_src_channel;                                                                              // router_003:src_channel -> pixel_buffer_avalon_sram_slave_rsp_width_adapter:in_channel
	...
	wire  [107:0] pixel_buffer_avalon_sram_slave_rsp_width_adapter_src_data;                                           // pixel_buffer_avalon_sram_slave_rsp_width_adapter:out_data -> rsp_demux:sink_data
	...
	wire    [4:0] pixel_buffer_avalon_sram_slave_rsp_width_adapter_src_channel;                                        // pixel_buffer_avalon_sram_slave_rsp_width_adapter:out_channel -> rsp_demux:sink_channel
	...
	wire  [107:0] cmd_mux_src_data;                                                                                    // cmd_mux:src_data -> pixel_buffer_avalon_sram_slave_cmd_width_adapter:in_data
	wire          cmd_mux_src_ready;                                                                                   // pixel_buffer_avalon_sram_slave_cmd_width_adapter:in_ready -> cmd_mux:src_ready
	wire    [4:0] cmd_mux_src_channel;                                                                                 // cmd_mux:src_channel -> pixel_buffer_avalon_sram_slave_cmd_width_adapter:in_channel
	...
	wire   [89:0] pixel_buffer_avalon_sram_slave_cmd_width_adapter_src_data;                                           // pixel_buffer_avalon_sram_slave_cmd_width_adapter:out_data -> pixel_buffer_avalon_sram_slave_burst_adapter:sink0_data
	...
	wire    [4:0] pixel_buffer_avalon_sram_slave_cmd_width_adapter_src_channel;                                        // pixel_buffer_avalon_sram_slave_cmd_width_adapter:out_channel -> pixel_buffer_avalon_sram_slave_burst_adapter:sink0_channel
	...
	test_mm_interconnect_0_cmd_demux rsp_demux_001 (
		.clk                (clk_50_clk_clk),                                             //       clk.clk
		.reset              (video_pixel_buffer_dma_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	test_mm_interconnect_0_cmd_demux rsp_demux_002 (
		.clk                (clk_50_clk_clk),                                             //       clk.clk
		.reset              (video_pixel_buffer_dma_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
